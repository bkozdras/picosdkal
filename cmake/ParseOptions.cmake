...
option(RPIPICOSDKAL_BUILD_DUMMY_EXECUTABLE OFF, "Build dummy executable for target with linked library")
...
message(STATUS "RPIPICOSDKAL_BUILD_DUMMY_EXECUTABLE: " ${RPIPICOSDKAL_BUILD_DUMMY_EXECUTABLE})
...
set(BUILD_DUMMY_EXECUTABLE OFF)
...
if (RPIPICOSDKAL_BUILD_LIB_FOR_TARGET)
    ...
    set(BUILD_LIB_STUBS_FOR_HOST OFF)
    set(BUILD_UNIT_TESTS OFF)
    if (RPIPICOSDKAL_BUILD_DUMMY_EXECUTABLE)
        set(BUILD_DUMMY_EXECUTABLE ON)
    endif (RPIPICOSDKAL_BUILD_DUMMY_EXECUTABLE)
else ()
    set(BUILD_LIB_FOR_TARGET OFF)
...
message(STATUS "BUILD_DUMMY_EXECUTABLE: " ${BUILD_DUMMY_EXECUTABLE})
