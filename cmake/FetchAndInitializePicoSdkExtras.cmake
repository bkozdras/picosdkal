...
if (NOT PICO_EXTRAS_PATH)
    ...
    if (PICO_EXTRAS_FETCH_FROM_GIT)
        ...
        FetchContent_Declare(
                ...
                GIT_TAG ${VERSION_SDK_PICO_SDK_EXTRAS}
                GIT_SHALLOW 1
        )
        if (NOT pico_extras)
            message("Downloading Raspberry Pi Pico SDK extras")
            FetchContent_Populate(pico_extras)
            message("Downloaded Raspberry Pi Pico SDK extras")
