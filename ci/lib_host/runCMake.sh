...
THIS_DIR_NAME=${PWD##*/}
if [ "$THIS_DIR_NAME" != "build_lib_host" ]
then
    echo "ERROR: CI pipeline issue! This script (runCMake.sh) should be executed from build_lib_host directory!"
...
cmake \
    ...
    -DRPIPICOSDKAL_BUILD_LIB_FOR_HOST=ON ..
